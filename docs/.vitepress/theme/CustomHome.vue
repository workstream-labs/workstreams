    ...
    <section class="capabilities">
      <div class="container">
        <div class="section-head sr">
          <h2 class="section-title">Built for serious development</h2>
          <p class="section-sub">Every feature designed to keep you in flow.</p>
        </div>
        <div class="cap-grid">

          <div class="cap sr" style="--stagger:0">
            <div class="cap-icon">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z" fill="currentColor" stroke="none"/></svg>
            </div>
            <h4>Parallel execution</h4>
            <p>Run dozens of agents at once. Each gets its own isolated git worktree&thinsp;&mdash;&thinsp;no conflicts, no waiting.</p>
          </div>

          <div class="cap sr" style="--stagger:1">
            <div class="cap-icon">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><circle cx="18" cy="6" r="2.5"/><circle cx="6" cy="18" r="2.5"/><circle cx="6" cy="6" r="2.5"/><path d="M6 8.5V15.5"/><path d="M18 8.5c0 4-3 7-12 7"/></svg>
            </div>
            <h4>Agent agnostic</h4>
            <p>Deep Claude Code integration with session capture. Aider and Gemini also supported, with Codex coming soon.</p>
          </div>

          <div class="cap sr" style="--stagger:2">
            <div class="cap-icon">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><rect x="2" y="3" width="20" height="18" rx="3"/><path d="M7 8l4 4-4 4"/><path d="M13 16h4"/></svg>
            </div>
            <h4>LSP &amp; syntax highlighting</h4>
            <p>Full Language Server Protocol support in the desktop IDE. Syntax-highlighted diffs with word-level change detection.</p>
          </div>

          <div class="cap sr" style="--stagger:3">
            <div class="cap-icon">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg>
            </div>
            <h4>Live agent status</h4>
            <p>Animated indicators track each agent: idle, working, awaiting permission, or ready for review. Real-time in the sidebar.</p>
          </div>

          <div class="cap sr" style="--stagger:4">
            <div class="cap-icon">
            ...
            <h4>Online &amp; offline comments</h4>
            <p>Pull review comments from GitHub PRs alongside local offline comments. Both auto-included when resuming agents.</p>
          </div>

          <div class="cap sr" style="--stagger:5">
            <div class="cap-icon">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><path d="M12 20V10"/><path d="M18 20V4"/><path d="M6 20v-4"/></svg>
            </div>
            <h4>Session capture &amp; resume</h4>
            <p>Full conversation context preserved via stream-JSON capture. Resume agents mid-conversation without losing history.</p>
          </div>

          <div class="cap sr" style="--stagger:6">
            <div class="cap-icon">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><polyline points="20 6 9 17 4 12"/></svg>
            </div>
            <h4>Auto-commit on success</h4>
            <p>When an agent completes successfully, changes are committed automatically. No manual step needed to capture work.</p>
          </div>

          <div class="cap sr" style="--stagger:7">
            <div class="cap-icon">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="8" y1="13" x2="16" y2="13"/><line x1="8" y1="17" x2="13" y2="17"/></svg>
            </div>
            <h4>YAML config</h4>
            <p>One workstream.yaml defines agents, prompts, base branches, timeouts, and environment variables. Map or array format.</p>
          </div>

          <div class="cap sr" style="--stagger:8">
            <div class="cap-icon">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8"/><path d="M12 17v4"/></svg>
            </div>
            <h4>macOS desktop app</h4>
            <p>A native desktop IDE with worktree sidebar, integrated terminal, split diff viewer, and live agent status. Download and go.</p>
          </div>
