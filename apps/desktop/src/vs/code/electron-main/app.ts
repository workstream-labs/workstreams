...
import { GitWorktreeMainService } from '../../workbench/services/orchestrator/electron-main/gitWorktreeMainService.js';
import { HookNotificationServer } from '../../workbench/services/orchestrator/electron-main/hookNotificationServer.js';
// IHookNotificationService interface is in common/ to avoid Node.js imports in renderer
import { setupClaudeHooks } from '../../workbench/services/orchestrator/electron-main/claudeHookSetup.js';
...
export class CodeApplication extends Disposable {
	...
	private initChannels(accessor: ServicesAccessor, mainProcessElectronServer: ElectronIPCServer, sharedProcessClient: Promise<MessagePortClient>): void {
		...
		const hookNotificationServer = disposables.add(new HookNotificationServer(accessor.get(ILogService)));
